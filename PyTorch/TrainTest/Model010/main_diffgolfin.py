...
ex = Experiment('DiffGoLFin Model')
...
def main(seed, delta, shape, parent_folder, model_names, remove_model_data, remove_test, remove_all,
    ...
    model = tools.training_loop(shape, delta, seed, model_dirs, device,
                  ...
                  schedule_lambda_phys, schedule_lambda_bin, schedule_lambda_dice, val_split, states2generate, margin, min_density, max_density, generator_batch_size)
