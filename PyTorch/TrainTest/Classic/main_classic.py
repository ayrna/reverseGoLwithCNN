...
def main(seed, delta, shape, parent_folder, model_names, remove_model_data, remove_test, remove_all,
         ...
         val_split, states2generate,  margin, min_density, max_density, generator_batch_size, states2generate_test):
    ...
    # Train:
    print(f' --- 🐲 Starting training Classic Model ---')
    ...
    # loss_fn_classic = tools.get_custom_loss('BinaryFocalCrossEntropy',gamma = gamma, alpha=alpha, 
    ...
    classic_model = tools.training_loop(shape, delta, seed, classic_model_dirs, device,
                  ...
                  tolerance_dts, tolerance_lr, factor, warmup_epochs, schedule_lambda_phys, schedule_lambda_bin, schedule_lambda_dice, val_split, 
