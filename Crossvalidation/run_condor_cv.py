...
def config():
    ...
    tasks_config_dir = f'./task_config_cv'
    condor_output_dir= f'./condor_output_cv'
    priority = 0

@ex.main
def main(seeds, deltas, shapes, path_datos, epochs, hp_config, val_split, batch_size, tasks_config_dir, condor_output_dir, priority):
                ...
                jobs_data[shape_str][delta].append(
                            {
                                "task_config": {
                                    ...
                                    "gpumemory": 24000,
                                    "experiment_config": "",
                                    # "requirements": "(compute capability >= 7.0)",
    ...
    print(jobs_data)
    _launch_condor_jobs(
        jobs_data, 'CV_Classic', tasks_config_dir, condor_output_dir, priority
    )
