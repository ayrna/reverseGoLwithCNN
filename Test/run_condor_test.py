...
def config():
    ...
    tasks_config_dir = f'./task_config_Test'
    condor_output_dir= f'./condor_output_Test'
    priority = 0

@ex.main
def main(seeds, deltas, shapes, path_datos, batch_size, tasks_config_dir, condor_output_dir, priority):
    ...
    print(jobs_data)
    _launch_condor_jobs(
        jobs_data, 'Train_GoL', tasks_config_dir, condor_output_dir, priority
    )
